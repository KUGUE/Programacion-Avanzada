                        ...
                        <div class="col-md-3 p-2">
                            <div class="card mb-1" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <a data-product='<?php echo json_encode($lista)?>' onclick="llenarDatos(this)" class="btn btn-warning col-6" data-bs-toggle="modal" data-bs-target="#updateProduct">Editar</a>
...
function llenarDatos(target) {
            let product = JSON.parse(target.getAttribute('data-product'));
               document.getElementById("inputOculto").value = "upload";
            console.log(product);
